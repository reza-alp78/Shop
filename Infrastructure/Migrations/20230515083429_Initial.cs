        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryProductPropertyId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductRegisters_CategoryProductProperties_CategoryProductPropertyId",
                        column: x => x.CategoryProductPropertyId,
                        principalTable: "CategoryProductProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductRegisters_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRegisters_CategoryProductPropertyId",
